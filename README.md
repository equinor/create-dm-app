...
- Node 14.0.0 or later (it’s not required on the server)
...
This will create a new folder "my-app" with all the required source code.
...
To run your custom application locally, you will need a local instance of DMSS running locally.
...
When in the `my-app`folder in the terminal, run
...
The webpage will automatically reload if you make changes to the code.<br>
